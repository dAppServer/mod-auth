...
import { CreateAccountDTO, CreateAccountResponseDTO, DeleteAccountDTO, EncryptedRequestDTO, EncryptedResponseDTO } from "../../../Code/server/src/interfaces/encrypted-request.interface.ts";

import { FileSystemService } from "../../../Code/server/src/modules/io/filesystem/fileSystemService.ts";
import { AuthLetheanService } from "./lethean.service.ts";
